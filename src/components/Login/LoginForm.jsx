...
const LoginForm = () => {
  return (
    <div>
        ...
        {/* Giriş Form Kısmı */}
        <div className="bg-white rounded-lg shadow-md p-6 w-full max-w-md py-7">
        <button className="w-full py-3 px-4 mb-4 flex items-center justify-center bg-gray-50 text-gray-800 font-semibold rounded-full shadow border-2 border-transparent hover:border-gray-600 transition duration-300 gap-3">
          ...
          <p className="text-xs text-gray-400 mt-4 text-center">
            By continuing, you agree to theArtificialTeam's <Link to='/terms'>Consumer Terms</Link> and <Link to='/usage-policy'>Usage Policy</Link>, and acknowledge their <Link to='/privacy'>Privacy Policy</Link>.
          </p>
